...
import { openPopup } from "../utils/openPopup.jsx";
import {
  setupHoverAnimations,
  setupEntranceAnimations,
  setupTextEntranceAnimations,
} from "../utils/initWorkItemAnimations.js";

gsap.registerPlugin(ScrollTrigger);

function WorkItem({ name, bg, link, description }) {
  ...
  const handleOpen = (e) => {
    ...
    openPopup({ img, name, link, description });
  };
