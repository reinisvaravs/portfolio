  ...
  return (
    <div className="work">
      ...
      <WorkItem
        ...
        linkText="Learn more"
        description="An automated Instagram analytics system using Make, Apify, and Airtable. The system scrapes profiles, posts, and reels daily into Airtable. Useful for marketing agencies, talent managers, and brand teams. Fully automated - no manual tracking needed. It tracks daily growth and every other aspect of the profile and posts."
      ...
      <WorkItem
        ...
        description="This is a full-stack e-commerce platform with secure user registration and test-mode Stripe subscriptions. No real payments are processed. The React frontend is clean and minimal for demo purposes."
